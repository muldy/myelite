    ...
    ipcRenderer.on('journal', function (ipcEvent, event) {
        ...
        if ((event.event == "MissionAccepted") ||
            ...
            $.notify({
                title: event.event,
                message: 
                "Federation:" +federal_ranks[event.Federation]+"<br>"+
                "Empire:" +empire_ranks[event.Empire]+"<br>"+
            ...
            $("#global_federation").html(federal_ranks[event.Federation]);
            $("#global_empire").html(empire_ranks[event.Empire]);
            $("#global_combat").html(event.Combat);
            $("#global_trade").html(event.Trade);
            $("#global_explore").html(event.Explore);
            $("#global_cqc").html(event.CQC);
