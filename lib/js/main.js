...
$(document).ready(function () {
    ...
    handlebars.mission_page = Handlebars.compile(document.getElementById("template_nav_missions").innerHTML)
    //var mission_line = Handlebars.compile(document.getElementById("template_mission_line").innerHTML)
    handlebars.mission_gist = Handlebars.compile(document.getElementById("template_left_missions").innerHTML)
    handlebars.goals_gist = Handlebars.compile(document.getElementById("template_right_missions").innerHTML)
    console.log("START");
